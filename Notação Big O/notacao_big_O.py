...
# Exibindo complexidade teórica
n = len(valores)
print("Complexidade teórica da pesquisa binária:")
print(f"Melhor caso: O(1)")
print(f"Caso médio/pior caso: O(log n), onde n = {n}, então log(n) ≈ {n.bit_length() - 1}")
